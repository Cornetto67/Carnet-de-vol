...
const regex = /function generateMonthlyReport\(year, monthStr, monthName\) \{[\s\S]*?document\.getElementById\('reportPreviewContainer'\)\.style\.display = 'block';\n\}/m;
...
const newFunc = `function generateMonthlyReport(year, monthStr, monthName) {
    ...
    let html = \`
        ...
        <h2 style="text-align: center; margin-bottom: 20px; color: black;">Synthèse Mensuelle - \${monthName} \${year}</h2>
    ...
    html += \`
            ...
            <tr>
                ...
                <td colspan="7" style="font-weight: bold; text-align: left; padding-left: 20px;">\${formatHour(totalSimu)}</td>
            </tr>
        </table>
    \`;
    ...
    html += \`
            ...
            <tr>
                <td style="text-align: left; font-weight: bold;">SIMULATEURS</td>
                <td colspan="7" style="font-weight: bold; text-align: left; padding-left: 20px;">\${formatHour(yTotalSimu)}</td>
            </tr>
        </table>
    \`;
